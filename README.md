...
* With [Final.py](https://github.com/ollulceland/Top-Trump/blob/main/Final.py), our players could pick a stat that they prefer to play against the evil computer empire(the component) in our Star Wars Top Trump:sunglasses:
