...
while True:
    ...
    def card_select():
        starwars_id = random.randint(1, 83)
        url = 'https://swapi.dev/api/people/{}/'.format(starwars_id)
        ...
        return {
            ...
            "mass": starwars["mass"],
            "eye_colour": starwars["eye_color"],
            "hair_colour": starwars["hair_color"]
    ...
    for e, c in enumerate(Dealt_hand):
        ...
        print(' Birth Year: {} '.format(c['birth_year']))
        print('Height: {} '.format(c['height']))
        print("""Mass: {}
             ...""".format(e, c['mass'])) ;sleep(2)
    ...
    if chosen_stat == 'birth year':
        user_stat = player_card['birth_year']
        ...
        print('You have a stat of {}'.format(user_stat)) ;
        sleep(1)
    elif chosen_stat == 'mass':
        user_stat = player_card['mass']
        print(user_stat)
    else:
