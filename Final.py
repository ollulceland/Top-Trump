...
while True:
    ...
    def card_select():
        ...
        return {
            "name": starwars["name"],
            "cargo_capacity": starwars["cargo_capacity"],
            "max_atmosphering_speed": starwars["max_atmosphering_speed"],
            "length": starwars["length"],
            "starship_class": starwars["starship_class"],
            "manufacturer": starwars["manufacturer"]
    ...
    for e, c in enumerate(Dealt_hand):
        ...
        print('Cargo Capacity: {} '.format(c['cargo_capacity']))
        print("""Length: {}
             ...""".format(e, c['length'])) ;sleep(2)
    ...
    if chosen_stat == 'length':
        user_stat = player_card['length']
        print('You have a stat of {}'.format(user_stat));
        sleep(1)
    elif chosen_stat == 'cargo capacity':
        user_stat = player_card['cargo_capacity']
        print('You have a stat of {}'.format(user_stat)) ;
        sleep(1)
